...
setup(
  ...
  version = '0.99.95',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/rmusmanno/ofx2xlsmbr/archive/v0.99.95.tar.gz',    # I explain this later on
